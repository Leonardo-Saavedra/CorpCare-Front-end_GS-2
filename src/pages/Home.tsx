  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <section className="py-16 px-6 bg-gray-50 text-center">
        <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-4">Como funciona</h2>
      ...
      <section className="py-16 px-6 text-center bg-white">
        <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-8">Por que escolher o CorpCare?</h2>
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <div className="bg-gray-50 p-6 rounded-xl shadow hover:shadow-md transition">
            <h3 className="text-xl font-semibold text-blue-700 mb-2">Prevenção</h3>
            <p className="text-gray-600">Detecta sinais de risco cedo e sugere intervenções.</p>
          </div>
          <div className="bg-gray-50 p-6 rounded-xl shadow hover:shadow-md transition">
            <h3 className="text-xl font-semibold text-blue-700 mb-2">Privacidade</h3>
            <p className="text-gray-600">Dados agregados e anonimizados — a privacidade é prioridade.</p>
          </div>
          <div className="bg-gray-50 p-6 rounded-xl shadow hover:shadow-md transition">
            <h3 className="text-xl font-semibold text-blue-700 mb-2">Acessível</h3>
            <p className="text-gray-600">Interface leve, dashboards para gestores e integração com APIs corporativas.</p>
          </div>
        </div>
      </section>

      {/* LISTA DE COLABORADORES - exemplo de integração */}
      <section className="py-16 px-6 bg-gray-50 text-center">
        <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-6">Colaboradores (exemplo de dados da API)</h2>
        ...
        {colaboradores.length > 0 ? (
          <div className="max-w-3xl mx-auto bg-white rounded-xl shadow p-6">
            <ul className="divide-y">
              {colaboradores.map((c) => (
                <li key={c.id} className="py-2 text-gray-700">
          ...
          !erro && <p className="text-gray-500">Nenhum colaborador encontrado (verifique sua API).</p>
        )}
      </section>

      {/* CONTATO */}
      <section className="py-16 px-6 text-center bg-white">
        <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-4">Precisa de ajuda?</h2>
        <p className="text-gray-600 mb-6">Fale com nossa equipe — estamos aqui para apoiar a saúde do time.</p>
