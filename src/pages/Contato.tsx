...
export default function Contato() {
  ...
  return (
    <section className="min-h-screen px-6 py-20 flex items-start justify-center bg-gray-200 dark:bg-gray-800 transition-colors duration-300">
      <div className="max-w-2xl w-full bg-white rounded-xl shadow-lg p-8 dark:bg-gray-900">
        <h1 className="text-3xl font-bold text-blue-700 mb-4">Contato</h1>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 bg-white dark:bg-gray-900 p-6 rounded-lg shadow-sm transition-colors duration-300">
          <div>
