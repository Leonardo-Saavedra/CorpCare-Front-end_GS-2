  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-start px-6 py-16 bg-gray-50">
      ...
      <div className="max-w-5xl space-y-10 text-gray-700">
        <div>
          <h2 className="text-2xl font-semibold text-blue-600 mb-3">Objetivo</h2>
        ...
        <div>
          <h2 className="text-2xl font-semibold text-blue-600 mb-3">Público‑alvo</h2>
          <p className="leading-relaxed">
        ...
        <div>
          <h2 className="text-2xl font-semibold text-blue-600 mb-3">Benefícios</h2>
        ...
        <div>
          <h2 className="text-2xl font-semibold text-blue-600 mb-3">Tecnologias</h2>
          <p className="leading-relaxed">
